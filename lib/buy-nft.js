...
$(document).ready(() => {
  ...
  function checkAvailability() {
    ...
    setTimeout(function(){
      fetch("https://bd93-2405-201-c01d-f822-28bc-f015-93c2-b5c1.in.ngrok.io/api/checkNftAvailabilityOnOpenSea", nftAvailabilityReqOptions)
        .then(response => response.json())
        .then(result => {
          if (result.success) {
            ...
            $("#get-terms").text("NFT not for sale on Opensea")
          }
        })
        .catch(error => console.log('error', error))
    }, 3000)
