...
$(document).ready(() => {
    ...
    async function checkClaim() {
        ...
        if (chainId == 1) {
            bnplAddress = '0x260C32eB38D1403bd51B83B5b7047812C70B7845' // mainnet 
        }
        ...
        console.log({marketId, bnplAddress})
        ...
        if (chainId == 1) {
            tellerV2Address = '0x00182FdB0B880eE24D428e3Cc39383717677C37e' // mainnet
        }
